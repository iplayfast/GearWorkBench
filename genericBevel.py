"""Generic Bevel Gear generator for FreeCAD

This module provides a generic bevel gear builder that can work with different
...
def bevelGear(doc, parameters, profile_func):
    """Bevel gear generator that accepts a custom tooth profile function.
    ...
    Args:
        ...
        parameters: Dictionary of gear parameters including:
            ...
            - face_width: Width of gear face (cone length)
            - pitch_angle: Pitch cone angle in degrees
            - pressure_angle: Pressure angle in degrees
            - spiral_angle: Spiral angle (0 for straight bevel)
