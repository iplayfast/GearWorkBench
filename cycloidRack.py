...
def generateCycloidRackPart(doc, parameters):
    ...
    result = genericRack.rackGear(
        doc, parameters, profile_func=generateCycloidRackToothProfile
    )
...
class CycloidRack:
    ...
    def __init__(self, obj):
        ...
        obj.addProperty(
            ...
            "Height",
            "CycloidRack",
            QT_TRANSLATE_NOOP("App::Property", "Gear face width"),
        ).Height = H["height"]
        ...
        obj.addProperty(
            ...
            "AddendumFactor",
            "CycloidRack",
            QT_TRANSLATE_NOOP("App::Property", "Head height factor"),
        ).AddendumFactor = H["addendum_factor"]
        obj.addProperty(
            "App::PropertyFloat",
            "DedendumFactor",
            "CycloidRack",
            QT_TRANSLATE_NOOP("App::Property", "Root depth factor"),
